...
function jqGridInclude()
{
    ...
    var modules = [
        {include: true, incfile:'grid.locale-es.js'},  // jqGrid translation
...
//        	filename = 'http://localhost/durango/js/grid/jqgrid/'+modules[i].incfile;
        	filename =  base_url+'js/grid/jqgrid/'+modules[i].incfile;
