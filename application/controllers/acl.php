...
class Acl extends Acl_controller
{
    ...
    function edit_acl(){
        ...
        set_flash_message(lang('msg_acl_updated'),FLASH_MSG_SUCCESS);
    ...
    function form_acl($targetid=0, $targettype=0){
        ...
        if (count($target) > 0){
            ...
            if ($targettype == 2)
            {
                $data['title'] = "(".lang("label_user").": " . $target->NAME . ")";
                ...
                $data['title'] = "(".lang("label_group").": " . $target->NAME . ")";

            $template['_B'] = 'acl/acl_view.php';
