  ...
  function getrootMenus(){
   ...
   /**
    ...
    function generateallActiveTreeArrayByUser($userid) {
        ...
        $sql = 'select id,name,shortdesc,status,parentid,page_uri,public.menu.orderr, menu.resourceid, acluser."RESOURCEID"
                from menu left join
                ...
                order by parentid asc, public.menu.orderr asc';
