...
class Users_model extends CI_Model{
     ...
     */
    function insert($nick, $paswd, $name, $surename, $email, $cellular, $subsecretary, /* $department,*/ $enable){
...
//        $this->update_user_department($id, $department);
     ...
     * @param  bool, available status
     */
    function update_all($id, $nick, $name, $surname, $email, $cellular, $subsecretary, $enable){
